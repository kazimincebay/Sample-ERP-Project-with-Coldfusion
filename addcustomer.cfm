...
<body>
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
      ...
      <div class="container">
        <div class="row">
          <div class="col mt-3">
            <cfform method="post" action="addcustomercontrol.cfm">
              <div class="mb-3">
                <label  class="form-label">Kurumsal Üye Adı</label>
                <cfinput type="text" required="true" class="form-control" name="customerName"/>
              </div>
              <input type="submit" value="Kurumsal Üye Ekle" class="btn btn-primary"/>
            </cfform>
          </div>
        </div>
      </div>
