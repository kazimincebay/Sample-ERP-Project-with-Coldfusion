...
<body>
   ...
   <cfquery name="getcustomerbyId" datasource="StokTakip">
    select CustomerName from Customers where customerId='#form.CUSTOMERID#'
  </cfquery>
  <div class="container">
    <div class="row">
      <div class="col mt-3">
        <cfform method="post" action="deletecustomerend.cfm">
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <cfinput type="text" disabled value="#getcustomerbyId.CUSTOMERNAME#" class="form-control" name="customerName"/>
          </div>
          <div>
            <cfoutput> Kurumsal Üye Silinecek Emin Misiniz?
            </cfoutput>
          </div>
          <input type="submit" value="Sil" class="btn btn-danger mt-2"/>
        </cfform>
